...
export async function POST(request: NextRequest) {
  try {
    ...
    const demoConversation = [
      ...
      { role: 'assistant' as const, content: "Nice! A fellow techie. Do you prefer working on projects solo or jamming with others?" },
      { role: 'user' as const, content: "I like small groups, like 2-3 people max. Big crowds drain me." },
      { role: 'assistant' as const, content: "Totally get that. When you hang out with friends, what's your ideal vibe - chill at home, explore new cafes, or something active?" },
